...
- 解析対象: 36 モジュール / 41 routine / 265 文
- DDL スナップショット: `schema.sql@d6f64025`
- 診断: 195 件（うち ERROR 8 件）
...
| 型解決率 | 99.1%（114/115） | Phase 1 で 95% 以上 |
...
| `b04_3_implicit_cursor_attrs` | procedure | 1 | 17 | — |
| `b04_4_1_explicit_cursor` | procedure | 1 | 4 | — |
| `b04_4_2_cursor_for_loop` | procedure | 1 | 6 | — |
| `b04_4_3_for_update_current_of` | procedure | 1 | 11 | — |
...
| `b05_4_call_log_msg` | procedure | 1 | 10 | — |
