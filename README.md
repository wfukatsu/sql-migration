...
| **意味的同等性（AUTO 対象）** | **100%**（金額の 2 規約とも AUTO 26/26 が実 Oracle と一致） |
| 判定（2026-09-20 の実測、金額の規約ごと） | scaled: AUTO 23 / REVIEW 16 / REDESIGN 26、double: AUTO 20 / REVIEW 19 / REDESIGN 26 |

**数値は合成 corpus 上のものであり、実案件耐性の証拠ではありません。** 非 AUTO の 42 件（scaled）を塞いでいるのは
